...
// PageXmlSeparatorRegion represents separators that lie between columns and
// paragraphs and can be used to logically separate different articles from each other.
type PageXmlSeparatorRegion struct {
	...
	// Orientation is the angle the rectangle encapsulating a region must be rotated
	...
	// Colour is the colour of the separator.
	Colour *PageXmlColourSimpleType `xml:"colour,attr,omitempty"`
}

// regionItem implements PageXmlRegionItem.
func (*PageXmlSeparatorRegion) regionItem() {}
