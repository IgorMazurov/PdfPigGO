...
// PageXmlChartRegion represents a region containing charts or graphs of any type.
type PageXmlChartRegion struct {
	...
	// Type is the type of chart in the region.
	Type *ChartSimpleType `xml:"type,attr,omitempty"`
...
func (*PageXmlChartRegion) regionItem() {}
