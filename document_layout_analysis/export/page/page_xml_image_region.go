...
// PageXmlImageRegion represents an image region in PAGE XML documents. An image
// is considered to be more intricate and complex than a graphic, such as photos
// or drawings.
type PageXmlImageRegion struct {
	...
	// ColourDepth is the colour bit depth required for the region.
	ColourDepth *ColourDepthSimpleType `xml:"colourDepth,attr,omitempty"`
...
func (*PageXmlImageRegion) regionItem() {}
