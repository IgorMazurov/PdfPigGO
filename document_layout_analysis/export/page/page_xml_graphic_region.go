...
// PageXmlGraphicRegion represents a region containing simple graphics such as
// a company logo, letterhead, decoration, frame, handwritten annotation, stamp,
// signature, barcode, paper grow, punch hole, or other graphic elements.
type PageXmlGraphicRegion struct {
	...
	// Type is the type of graphic in the region.
	Type *PageXmlGraphicsSimpleType `xml:"type,attr,omitempty"`

	// NumColours is an approximation of the number of colours used in the region.
	NumColours *int `xml:"numColours,attr,omitempty"`
...
func (*PageXmlGraphicRegion) regionItem() {}
