...
// PageXmlUnknownRegion represents a region whose content type could not be determined.
type PageXmlUnknownRegion struct {
...
func (*PageXmlUnknownRegion) regionItem() {}
