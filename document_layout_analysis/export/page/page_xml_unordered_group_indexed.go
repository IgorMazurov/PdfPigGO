...
// PageXmlUnorderedGroupIndexed represents an indexed group containing ordered elements
// in PAGE XML documents, with optional caption, type classification, and continuation flag.
type PageXmlUnorderedGroupIndexed struct {
	...
	// Index defines the order position within the current hierarchy level.
