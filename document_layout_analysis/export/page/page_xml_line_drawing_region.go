...
// PageXmlLineDrawingRegion represents a line drawing region in PAGE XML documents.
// A line drawing is a single colour illustration without solid areas.
type PageXmlLineDrawingRegion struct {
	...
	// PenColour is the pen (foreground) colour of the region.
	PenColour *PageXmlColourSimpleType `xml:"penColour,attr,omitempty"`
...
func (*PageXmlLineDrawingRegion) regionItem() {}
